...
async def start(bot, update):
    ...
    if update_channel:
        try:
            ...
            await update.reply_text(
                text="<b>🔊 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 C𝗵𝗮𝗻𝗻𝗲𝗹 and try again 🔊</b>",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text=" 📢 Join Our Channel 📢", url=f"https://t.me/{MT_UPDATE}")]
              ])
            )
            return
        except Exception:
    ...
    await bot.send_photo(
        ...
        photo="https://telegra.ph/file/f1cd3000f1238b23dafe6.jpg",
